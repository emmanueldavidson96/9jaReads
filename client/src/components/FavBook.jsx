...
import favLibrary from "../assets/1.jpg";
  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
            <img src={favLibrary} alt='' className='rounded md:w-10/12' />
        </div>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>
                ...
                Molestias consectetur, id molestiae excepturi 
                provident dolorem corporis est. Ab facere eos, illo nisi magnam 
                assumenda! Possimus voluptates optio reprehenderit quas quo.
            </p>
