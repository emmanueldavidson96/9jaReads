...
export default function Login() {
    const {login, loginWithGmail} = useContext(AuthContext)
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <p>If you have an account, Please <Link to="/sign-up" className="text-blue-600 underline">Sign up</Link></p>
            ...
            <FaGooglePlusSquare color="red" className="w-12 h-12"/>
              <button className="block " onClick={handleRegister}>Login with Google</button>
            </div>
          </div>
        </div>
      </div>
